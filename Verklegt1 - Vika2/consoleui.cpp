...
{
    cout << TAB << "----------------------------------------------------------------------------" << endl;
    cout << TAB << "      ____    ____       ____________   ______  _____   ______   ______" << endl;
    cout << TAB << "     /\\__/\\  /\\__/\\     |\\ _________/| |\\ ___/\\|\\__ /| |\\ ___/\\ /\\___ /|" << endl;
    cout << TAB << "    / /  \\ \\/ /  \\ \\    | |   ______|/ | |   \\  |  | | | |   | | |   | |" << endl;
    cout << TAB << "   / /    \\  /    \\ \\   | |  |___/|    | |    \\ |  | | | |   | | |   | |" << endl;
    cout << TAB << "  / /  /\\  \\/  /\\  \\ \\  | |   ___|/__  | |  |\\ \\|  | | | |   | | |   | |" << endl;
    cout << TAB << " / /  /  \\    /  \\  \\ \\ | |  |______/| | |  | \\    | | | |   |___|   | |" << endl;
    cout << TAB << " \\/__/    \\__/    \\__\\/  \\|_________|/  \\|__|/ \\___|/   \\|___________|/" << endl;
    cout << TAB << "----------------------------------------------------------------------------" << endl;
